...
class SQueue{
     ...
     ******************************************/
    Node* clearHelper(Node* heap);
    void printPostsQueue(Node* heap) const;
    Node* mergeWithQueueHelper(Node* firstNode, Node* secondNode);
    Node* copyConstructorHelper(const Node* rhs);
    Post getNextPostHelper(Node* tracker);
    void setPriorityFnHelper(Node* heap, Node* curr); 
};
#endif
